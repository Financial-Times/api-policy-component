...
| stripBodyTree                         | Removes the `bodyTree` field from the response unless the INCLUDE_BODY_TREE policy is present                                                                                                                      | /content, /content-preview, /internalcontent-preview, /enrichedcontent, /internalcontent         |
