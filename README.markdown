...
| stripBodyTree                         | Removes the `bodyTree` field from the response unless the INCLUDE_BODY_TREE policy is present                                                                                                                      | /drafts/content, /internalcontent, /enrichedcontent, /content                                    |
