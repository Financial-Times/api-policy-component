...
public class PolicyBrandsResolverTest {
  ...
  public static final String FASTFT_BRAND =
      "http://api.ft.com/things/5c7592a8-1f0c-11e4-b0cb-b2227cce2b54";
  public static final String ALPHAVILLE_BRAND =
      "http://api.ft.com/things/89d15f70-640d-11e4-9803-0800200c9a66";
  public static final String BEYONDBRICS_BRAND =
  ...
  @Mock private MutableRequest mutableRequest;
  ...
  public void brandParametersShouldBeAddedWhenPolicyIsFastFtContentOnly() {
    ...
    assertEquals(
        "FASTFT brand was not passed in to add method", FASTFT_BRAND, valueArgument.getValue());
  }
  ...
  public void brandParametersShouldBeAddedWhenPolicyIsExcludeFastFtContent() {
    ...
    verify(mutableRequest, times(1)).getQueryParameters();
    assertEquals(
        "notForBrand was not passed in to add method", "notForBrand", keyArgument.getValue());
    assertEquals(
        "FASTFT brand was not passed in to add method", FASTFT_BRAND, valueArgument.getValue());
  }
}
