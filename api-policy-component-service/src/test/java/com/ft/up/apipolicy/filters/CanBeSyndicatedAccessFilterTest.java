...
public class CanBeSyndicatedAccessFilterTest {
  ...
  public void setUp() {
    filter =
        new CanBeSyndicatedAccessFilter(
            JsonConverter.testConverter(), Policy.RESTRICT_NON_SYNDICATABLE_CONTENT);
  }
  ...
  public void shouldNotModifyResponseWhenNoPolicy() {
    ...
    final String responseBody =
        "{\"bodyXML\":\"<body>Testing.</body>\",\"canBeSyndicated\":\"no\"}";
  ...
  public void shouldReturnForbiddenErrorWhenPolicyAndCanBeSyndicatedFieldNotYes() {
    ...
    MutableResponse chainedResponse =
        createSuccessfulResponse(
            "{\"bodyXML\":\"<body>Testing.</body>\",\"canBeSyndicated\":\"verify\"}");
  ...
  public void shouldStripNestedImageWhenPolicyAndCanBeSyndicatedFieldNotYesForNestedImageContent() {
    ...
    MutableResponse chainedResponse =
        createSuccessfulResponse(
            "{\"bodyXML\":\"<body>Testing.</body>\",\"canBeSyndicated\":\"yes\",\"mainImage\":{\"id\":\"sampleId\",\"canBeSyndicated\":\"verify\"}}");

    when(mockChain.callNextFilter(request)).thenReturn(chainedResponse);

    final String expectedFilteredResponseBody =
        "{\"bodyXML\":\"<body>Testing.</body>\",\"canBeSyndicated\":\"yes\"}";
