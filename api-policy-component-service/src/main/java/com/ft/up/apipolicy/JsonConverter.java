...
public class JsonConverter {
  ...
  public static final TypeReference<LinkedHashMap<String, Object>> JSON_MAP_TYPE =
      new TypeReference<LinkedHashMap<String, Object>>() {};
  public static final TypeReference<LinkedHashMap<String, Object>[]> JSON_ARRAY_TYPE =
      new TypeReference<LinkedHashMap<String, Object>[]>() {};
