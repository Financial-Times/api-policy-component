...
public class SuppressJsonPropertiesFilter extends AbstractImageFilter {
  ...
  public SuppressJsonPropertiesFilter(
      final JsonConverter jsonConverter, final String... jsonProperties) {
    this.jsonConverter = jsonConverter;
    this.jsonProperties = Arrays.asList(jsonProperties);
  }

  @Override
  public MutableResponse processRequest(
      final MutableRequest request, final HttpPipelineChain chain) {
  ...
  private MutableResponse processResponse(
    ...
    if (isListResponse(content)) {
      ...
      content.forEach(
          (k, v) ->
              processJsonArray(
                  request, (Map<String, Object>) v, jsonProperty, modifiedListContent));
  ...
  private void processJsonArray(
      ...
      Map<String, Object> content,
      String jsonProperty,
      List<Map<String, Object>> modifiedListContent) {
